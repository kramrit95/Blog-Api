...
import com.codewithamrit.blog.services.FileService;
...
public class PostController {
	...
	public ResponseEntity<List<PostDto>> searchPostByTitle(@PathVariable("keywords") String keywords) {
		List<PostDto> searchPostsResult = this.postService.serchPosts(keywords);
		return new ResponseEntity<List<PostDto>>(searchPostsResult, HttpStatus.OK);
